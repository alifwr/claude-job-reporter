...
7. Yesterday bullets describe what was COMPLETED or substantially WORKED ON. Today bullets describe what is IN PROGRESS or PLANNED NEXT — infer continuations from yesterday's unfinished prompts and open blockers when today's session data is sparse.
